"""Settings panel for Grafana Cloud Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__grafana_cloud_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=grafana_cloud_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_grafana_cloud"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("Grafana Cloud Settings & Accounts", level=2),
