# PST Testing Scenarios for Grafana Cloud Connector

## Part A: Authentication & Connectivity Verification
- **Scenario A1: Valid Credential Connect**: `connect_grafana_cloud_connector` saves token and validates endpoint.
...
- **Scenario C1: Connection Lifecycle**: Clean disconnect via `disconnect_grafana_cloud_connector` without lingering secrets.
