"""Pydantic schemas for Grafana Cloud Connector."""
...
class ConnectParams(BaseModel):
    label: str = Field(default="", description="Friendly connection label, e.g. Primary Grafana Cloud.")
    api_key: str = Field(description="Observability API Key")
    base_url: str = Field(default="https://grafana.com/api", description="Grafana Cloud API base URL.")
...
class GetMetricParams(BaseModel):
    connection_id: str = Field(default="", description="Optional connection ID.")
    metric_id: str = Field(description="Grafana Cloud Metric ID.")
